...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='fcn',
                        choices=['fcn32s', 'fcn16s', 'fcn8s',
                                 ...
                                 'cgnet', 'espnet', 'lednet', 'dfanet','psp','lepspnet'],
    ...
    parser.add_argument('--workers', '-j', type=int, default=4,#default=4
...
class Trainer(object):
    ...
    def train(self):
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            print("the image's size is:", images.size())
            ...
            print("the outputs's len is:", len(outputs))
